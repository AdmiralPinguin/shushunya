...
from .authority import ALLOWED_ACTIONS, Authority, pending_decision_ids
...
{
  "action": "answer_in_chat|ask_clarification|request_warmaster_mission|create_administratum_task|deliver_pending_reports|deliver_artifact|answer_pending_decision",
