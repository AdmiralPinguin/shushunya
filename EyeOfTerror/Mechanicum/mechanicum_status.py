...
COMPONENTS = {
    "Ceraxia": {
        ...
        "maturity": "controller_with_planning_quality_survey_gate_read_order_investigation_playbook_change_control_caller_contract_evidence_generic_edges_per_surface_verification_and_work_package_review",
    },
    "PlanningBrigade": {
        ...
        "maturity": "contracted_planning_department_with_role_quality_gates_investigation_playbook_change_control_field_trial_coverage_and_code_work_packages",
    },
    "CodeBrigade": {
        ...
        "maturity": "handoff_with_read_order_investigation_playbook_change_control_preflight_explicit_text_ast_guarded_natural_language_and_test_inferred_literal_patch_adapter_package_statuses_and_allowlisted_verification",
    },
}
...
ROADMAP = [
    ...
    },
    {
        ...
        "reason": "PlanningBrigade now emits problem framing, path hints, investigation playbooks, change-control plans, dependency maps, work breakdown, impact analysis, surface verification matrices, acceptance contracts, CodeBrigade brief blueprints, and implementation work packages; role services should wait until these contracts survive more real tasks.",
