...
tests provide a single imported symbol and simple literal expectation, or
replace a single literal return expression / module-level constant assignment
when that same evidence proves a mismatch.
