...
INTENT_SYSTEM_PROMPT = (
    ...
    "If the user asks whether there is news, pending reports, or whether the assistant wants to say something "
    "('что там ещё', 'что нового', 'есть новости?', 'хочешь что-то сказать?', 'докладывай', 'что хотела сказать'), "
    "return {\"intent\":\"deliver_reports\",\"confidence\":0..1}. "
