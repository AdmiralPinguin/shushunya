    ...
    try:
        ...
        return {
            ...
            "observed": {
                ...
                "trial_checks": {},
                "honest_evidence": {},
                "manifest_status": "missing_evidence",
                "patch_source": "",
                "changed_files": [],
            ...
            "review_questions": [
                "Evidence artifact is not present locally; rerun the trial or inspect compact accepted review records before scoring.",
                *[f"Check failure mode: {mode}" for mode in trial_spec.get("failure_modes_to_watch", [])],
            ],
            "acceptance_requirements": trial_spec.get("required_evidence", []),
            "score_sheet": {
                dimension: None
                for dimension in dimensions(spec)
            },
            "review_decision": "needs_evidence",
        }
