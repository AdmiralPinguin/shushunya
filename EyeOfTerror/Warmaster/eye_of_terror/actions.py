...
def gateway_actions() -> dict[str, Any]:
    return {
        ...
        "can_create_legacy_task": False,
        "legacy_direct_task_requires_explicit_opt_in": True,
        "can_start_runs": True,
        ...
        "legacy_direct_task_flow": ["POST /task with allow_legacy_direct_task=true", "POST /runs/{task_id}/preflight_http", "POST /runs/{task_id}/start_http"],
