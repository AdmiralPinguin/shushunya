...
from research_eval.manifest import ManifestError, load_suite, require_object, strict_json_load  # noqa: E402
from research_eval.metrics import aggregate_metrics  # noqa: E402
from research_eval.oracles import evaluate_legacy_artifact  # noqa: E402
from research_eval.results import ResultWriteError, write_result_atomic  # noqa: E402
from research_eval.runner import run_suite  # noqa: E402
from research_eval.subjects import FakeSubjectAdapter  # noqa: E402
...
class ExternalEvalCoreTests(unittest.TestCase):
    ...
    def test_private_oracles_are_never_sent_to_subject(self) -> None:
        subject = FakeSubjectAdapter(replay_results())
        result = run_suite(SUITE, subject, allowed_root=ROOT)
        self.assertTrue(result["run_valid"])
        serialized = json.dumps(subject.recorded_payloads, ensure_ascii=False).casefold()
        for forbidden in (
        ...
        self.assertEqual(
            set(subject.recorded_payloads[0]),
    ...
    def test_invalid_run_cannot_replace_existing_result(self) -> None:
