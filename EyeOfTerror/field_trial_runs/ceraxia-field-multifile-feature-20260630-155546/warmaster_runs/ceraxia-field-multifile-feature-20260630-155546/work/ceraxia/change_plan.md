...
Goal: кодовая задача: добавь небольшую multi-file feature с реализацией, тестом, документацией и caller update.
CERAXIA_TARGET_REPO: EyeOfTerror/field_trial_runs/ceraxia-field-multifile-feature-20260630-155546/fixture/repo
CERAXIA_FEATURE:
{
