...
def main() -> int:
    ...
    if agent_runner.looks_like_swe_task("Это не задача про программный код; собери источники и напиши отчет"):
    ...
    scoped_min_chars_requirement = required_min_chars_by_path_from_task(
        "Проверь: /work/story.md содержит рассказ не короче 12000 символов; "
        "/work/report.md содержит разделы Источники, Пробелы, Итоговая оценка.",
